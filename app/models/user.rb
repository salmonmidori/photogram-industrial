...
class User < ApplicationRecord
  ...
  has_many :pending_freceived_rollow_requests, -> { pending }, foreign_key: :recipient_id, class_name: "FollowRequest"
  ...
  has_many :pending_followers, through: :pending_freceived_rollow_requests, source: :sender
